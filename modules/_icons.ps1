...
function Initialize-WindowIcons {
    $pairs = @(
        ...
        @('NavCleanIcon', 'places/trash'), @('NavProtectIcon', 'status/privacy'),         @('NavDiagIcon', 'apps/nav_diag'), @('NavSysIcon', 'devices/nav_sys'), @('NavRollbackIcon', 'actions/undo'), @('NavDashIcon', 'apps/monitor'),
        @('RollbackFolderIcon', 'places/folder_open'),
