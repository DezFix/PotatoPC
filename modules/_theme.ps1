...
# палитра — Fluent Dark Mica 2026 (компактный сайдбар)
$script:Theme.CardBg          = Get-ThemeBrush "#2b2b33"
$script:Theme.CardBgHover     = Get-ThemeBrush "#32323c"
$script:Theme.CardBorder      = Get-ThemeBrush "#3a3a46"
$script:Theme.CardBgDim       = Get-ThemeBrush "#232329"
$script:Theme.CardBorderDim   = Get-ThemeBrush "#2e2e38"
...
# частые Thickness / CornerRadius — синглтоны (компакт 2026)
$script:Theme.PadCard         = [System.Windows.Thickness]::new(8,5,8,5)
$script:Theme.PadCardSys      = [System.Windows.Thickness]::new(10,7,10,7)
...
$script:Theme.CornerCard      = [System.Windows.CornerRadius]::new(6)
